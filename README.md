## OpenCV C++ multi focal stereo Camera Calibration
    The calibration program is modified by [stereo-calibration](hhttps://github.com/sourishg/stereo-calibration "悬停显示"), which can calibrate multi focal length stereo camera for MF-SLAM. 
