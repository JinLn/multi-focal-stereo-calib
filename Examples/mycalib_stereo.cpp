...
int main(int argc, char const *argv[])
{
  ...
  //stereoRectify(K1, D1, K2, D2, img1.size(), R, T, R1, R2, P1, P2, Q , CALIB_ZERO_DISPARITY,-1);
  mystereoRectify(K1, D1, K2, D2, img1.size(), R, T, R1, R2, P1, P2, Q , CALIB_ZERO_DISPARITY, -1,img1.size(), &validPixROI1 , &validPixROI2);
